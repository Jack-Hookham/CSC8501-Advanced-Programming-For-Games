...
private:
	...
	static int processLine(double timeTaken, const Prisoner* prisoner, const int lineNumber, const int lineIndex = 1);
	static int parseIf(double timeTaken, const Prisoner* prisoner, const int lineNumber, const std::vector<std::string>& tokens);
};
